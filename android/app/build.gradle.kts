...
dependencies {
    ...
    // Instrumented tests. These run on a real emulator in CI (see the android-emulator job in
    // .github/workflows/build.yml) and are the only thing here that proves the app actually
    // starts, rather than merely compiling.
